          ...
          <div className="hero-content">
            <div className="hero-text">
              {/* <div className="tagline"> */}
                ...
                {/* <span className="tagline-text">AI-Powered Experience</span> */}
              {/* </div> */}
              ...
              <p className="hero-description">
                {/* Revolutionize your note-taking with our eco-friendly, AI-enhanced reusable notebook. */}
                Explore with ReNoteAI the perfect blend of Handwritten Style and Digital Convenience to simplify your life.
              </p>
            ...
            <div className="hero-image">
              ...
              <img src={nature} alt="Description of your image" className='image-place-holder1' />
              </div>
